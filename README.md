...
| **TWZRD Agent Intel** | Trust scoring MCP for AI agents on Solana — verify agent wallet identity and autonomy score before authorizing x402 micropayments in health data pipelines | [![Website](https://img.shields.io/badge/website-blue)](https://intel.twzrd.xyz) |
